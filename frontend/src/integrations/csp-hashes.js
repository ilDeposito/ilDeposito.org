...
const SCRIPT_SRC_BASE = "'self' 'unsafe-inline' 'wasm-unsafe-eval' https://www.youtube.com https://stats.ildeposito.org";
...
const DIRECTIVES = [
  ...
  "font-src 'self'",
  "connect-src 'self' https://tile.openstreetmap.org https://stats.ildeposito.org",
