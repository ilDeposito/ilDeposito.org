...
/*!**************************************************!*\
  !*** ./components/social-share/_social-share.js ***!
  \**************************************************/
...
(function (Drupal, once) {
  ...
  Drupal.behaviors.ilDepositoSocialShare = {
    attach: function attach(context, settings) {
      once('ildeposito-social-share', '[data-social-share]', context).forEach(function (el) {
        // Dispositivi touch (mobile/tablet) → Web Share API nativa
        var isMobile = window.matchMedia('(pointer: coarse)').matches;
        if (isMobile && navigator.share) {
          el.addEventListener('click', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
            var _t;
