...
Drupal.behaviors.ilDepositoSocialShare = {
  attach: function attach(context) {
    document.querySelectorAll('.social-share[data-bs-toggle="popover"]').forEach(function (el) {
      // Mobile: usa Web Share API
      var isMobile = window.matchMedia('(pointer: coarse)').matches && typeof navigator.share === 'function';
      if (isMobile) {
